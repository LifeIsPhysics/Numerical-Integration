...
{
        std::make_tuple([](double x){ return std::exp(-x); }, std::make_pair(0.,1.), 100000, 1 - 1 / M_E),
        std::make_tuple([](double x){ return std::cos(x) - 3.0 / std::pow(x, 5.0); }, std::make_pair(1.,4.), 100000, std::sin(4.0) - std::sin(1.0) - 765.0 / 1024.0),
};
